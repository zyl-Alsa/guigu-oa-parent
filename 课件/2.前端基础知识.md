...
![在这里插入图片描述](https://img-blog.csdnimg.cn/2b4a9caa4a424a3aa37af20aba93a23e.png#pic_center)
...
#### 第一步：引入vue和axios的js文件

在html页面引入相关js文件-vue和axios的js文件
...
创建json文件，在代码通过axios发送ajax请求得到数据，在控制台显示
